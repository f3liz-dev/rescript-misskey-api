...
type postAdminMetaResponse = {
  ...
  deeplAuthKey: JSON.t,
  deeplIsPro: bool,
  @as("ctav3SaKey") ctav3saKey: JSON.t,
  @as("ctav3ProjectId") ctav3projectId: JSON.t,
  @as("ctav3Location") ctav3location: JSON.t,
  @as("ctav3Model") ctav3model: JSON.t,
  @as("ctav3Glossary") ctav3glossary: JSON.t,
 ...
 * **Credential required**: *No*
 */
let getServerInfo = (~body as _, ~fetch: (~url: string, ~method_: string, ~body: option<JSON.t>) => Promise.t<JSON.t>): promise<getServerInfoResponse> => {
 ...
 * **Credential required**: *No*
 */
let postServerInfo = (~body as _, ~fetch: (~url: string, ~method_: string, ~body: option<JSON.t>) => Promise.t<JSON.t>): promise<postServerInfoResponse> => {
