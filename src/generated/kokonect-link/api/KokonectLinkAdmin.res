...
let postAdminAvatarDecorationsCopy = (~body: postAdminAvatarDecorationsCopyRequest, ~fetch: (~url: string, ~method_: string, ~body: option<JSON.t>) => Promise.t<JSON.t>): promise<postAdminAvatarDecorationsCopyResponse> => {
  ...
  let validatedResponse = response->S.parseOrThrow(postAdminAvatarDecorationsCopyResponseSchema)
  validatedResponse
->Promise.resolve
  })
}
...
type postAdminAvatarDecorationsListRemoteResponse = array<JSON.t>

let postAdminAvatarDecorationsListRemoteResponseSchema = S.array(S.json)
...
let postAdminAvatarDecorationsListRemote = (~body: postAdminAvatarDecorationsListRemoteRequest, ~fetch: (~url: string, ~method_: string, ~body: option<JSON.t>) => Promise.t<JSON.t>): promise<postAdminAvatarDecorationsListRemoteResponse> => {
  ...
  let validatedResponse = response->S.parseOrThrow(postAdminAvatarDecorationsListRemoteResponseSchema)
  validatedResponse
->Promise.resolve
  })
}
...
let postAdminEmojiSteal = (~body: postAdminEmojiStealRequest, ~fetch: (~url: string, ~method_: string, ~body: option<JSON.t>) => Promise.t<JSON.t>): promise<postAdminEmojiStealResponse> => {
  ...
  let validatedResponse = response->S.parseOrThrow(postAdminEmojiStealResponseSchema)
  validatedResponse
->Promise.resolve
  })
}
...
type postAdminUpdateMetaRequest = {
  ...
  ctav3SaKey: option<JSON.t>,
  ctav3ProjectId: option<JSON.t>,
  ctav3Location: option<JSON.t>,
  ctav3Model: option<JSON.t>,
  ctav3Glossary: option<JSON.t>,
  ...
  remoteObjectStorageUseSSL: option<bool>,
  remoteObjectStorageUseProxy: option<bool>,
  remoteObjectStorageSetPublicRead: option<bool>,
  remoteObjectStorageS3ForcePathStyle: option<bool>,
