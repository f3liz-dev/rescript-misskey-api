// Generated wrapper
import * as AdminApi from '../api/KokonectLinkAdmin.res.mjs';
import * as DefaultApi from '../api/KokonectLinkDefault.res.mjs';
import * as MetaApi from '../api/KokonectLinkMeta.res.mjs';
import * as WebhooksApi from '../api/KokonectLinkWebhooks.res.mjs';
import * as AntennasApi from '../api/KokonectLinkAntennas.res.mjs';
import * as FederationApi from '../api/KokonectLinkFederation.res.mjs';
import * as AppApi from '../api/KokonectLinkApp.res.mjs';
import * as AuthApi from '../api/KokonectLinkAuth.res.mjs';
import * as AccountApi from '../api/KokonectLinkAccount.res.mjs';
import * as ChannelsApi from '../api/KokonectLinkChannels.res.mjs';
import * as NotesApi from '../api/KokonectLinkNotes.res.mjs';
import * as ChartsApi from '../api/KokonectLinkCharts.res.mjs';
import * as ClipsApi from '../api/KokonectLinkClips.res.mjs';
import * as ClipApi from '../api/KokonectLinkClip.res.mjs';
import * as DriveApi from '../api/KokonectLinkDrive.res.mjs';
import * as UsersApi from '../api/KokonectLinkUsers.res.mjs';
import * as FlashApi from '../api/KokonectLinkFlash.res.mjs';
import * as FlashsApi from '../api/KokonectLinkFlashs.res.mjs';
import * as FollowingApi from '../api/KokonectLinkFollowing.res.mjs';
import * as GalleryApi from '../api/KokonectLinkGallery.res.mjs';
import * as HashtagsApi from '../api/KokonectLinkHashtags.res.mjs';
import * as ReactionsApi from '../api/KokonectLinkReactions.res.mjs';
import * as NotificationsApi from '../api/KokonectLinkNotifications.res.mjs';
import * as PagesApi from '../api/KokonectLinkPages.res.mjs';
import * as ResetPasswordApi from '../api/KokonectLinkResetPassword.res.mjs';
import * as NonProductiveApi from '../api/KokonectLinkNonProductive.res.mjs';
import * as RoleApi from '../api/KokonectLinkRole.res.mjs';
import * as ListsApi from '../api/KokonectLinkLists.res.mjs';
import * as ChatApi from '../api/KokonectLinkChat.res.mjs';
import * as GroupsApi from '../api/KokonectLinkGroups.res.mjs';
...
export const Admin = {
  ...
  async postAdminAvatarDecorationsCopy(client, request) {
    return AdminApi.postAdminAvatarDecorationsCopy({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminAvatarDecorationsList(client, request) {
  ...
  async postAdminAvatarDecorationsListRemote(client, request) {
    return AdminApi.postAdminAvatarDecorationsListRemote({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminDeleteAccount(client, request) {
    return AdminApi.postAdminDeleteAccount({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminDeleteAllFilesOfAUser(client, request) {
    return AdminApi.postAdminDeleteAllFilesOfAUser({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminDriveFiles(client, request) {
  ...
  async postAdminEmojiSteal(client, request) {
    return AdminApi.postAdminEmojiSteal({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminEmojiUpdate(client, request) {
  ...
  async postAdminInviteRevoke(client) {
    return AdminApi.postAdminInviteRevoke({
      fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminQueueClear(client, request) {
  ...
  async postAdminQueueJobs(client, request) {
    return AdminApi.postAdminQueueJobs({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminQueuePromoteJobs(client, request) {
    return AdminApi.postAdminQueuePromoteJobs({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminQueueQueueStats(client, request) {
    return AdminApi.postAdminQueueQueueStats({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminQueueQueues(client) {
    return AdminApi.postAdminQueueQueues({
      fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminQueueRemoveJob(client, request) {
    return AdminApi.postAdminQueueRemoveJob({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminQueueRetryJob(client, request) {
    return AdminApi.postAdminQueueRetryJob({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminQueueShowJob(client, request) {
    return AdminApi.postAdminQueueShowJob({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminQueueShowJobLogs(client, request) {
    return AdminApi.postAdminQueueShowJobLogs({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminResolveAbuseUserReport(client, request) {
  ...
  async postAdminServerInfo(client) {
    return AdminApi.postAdminServerInfo({
      fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postAdminShowModerationLogs(client, request) {
...
export const Default = {
  ...
  async postITruncateAccount(client, request) {
    return DefaultApi.postITruncateAccount({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postIUpdateEmail(client, request) {
...
export const Meta = {
  ...
  async getServerInfo(client) {
    return MetaApi.getServerInfo({
      fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postServerInfo(client) {
    return MetaApi.postServerInfo({
      fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
};
...
export const Federation = {
  ...
  async getFederationRemoteSoftware(client, request) {
    return FederationApi.getFederationRemoteSoftware({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postFederationRemoteSoftware(client, request) {
    return FederationApi.postFederationRemoteSoftware({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postFederationShowInstance(client, request) {
...
export const Account = {
  ...
  async postIAutoDeleteSettings(client) {
    return AccountApi.postIAutoDeleteSettings({
      fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postIFavorites(client, request) {
  ...
  async postIFollowersServers(client) {
    return AccountApi.postIFollowersServers({
      fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postIGalleryLikes(client, request) {
  ...
  async postIUpdateAutoDeleteSettings(client, request) {
    return AccountApi.postIUpdateAutoDeleteSettings({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postIUserGroupInvites(client, request) {
    return AccountApi.postIUserGroupInvites({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postMuteList(client, request) {
  ...
  async postVerifyEmail(client, request) {
    return AccountApi.postVerifyEmail({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
};
...
export const Notes = {
  ...
  async postNotesBubbleTimeline(client, request) {
    return NotesApi.postNotesBubbleTimeline({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postNotesChildren(client, request) {
  ...
  async postNotesDraftsCount(client) {
    return NotesApi.postNotesDraftsCount({
      fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postNotesDraftsCreate(client, request) {
    return NotesApi.postNotesDraftsCreate({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postNotesDraftsDelete(client, request) {
    return NotesApi.postNotesDraftsDelete({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postNotesDraftsList(client, request) {
    return NotesApi.postNotesDraftsList({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postNotesDraftsUpdate(client, request) {
    return NotesApi.postNotesDraftsUpdate({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postNotesEventsSearch(client, request) {
    return NotesApi.postNotesEventsSearch({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postNotesGlobalTimeline(client, request) {
  ...
  async postNotesHistory(client, request) {
    return NotesApi.postNotesHistory({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postNotesHybridTimeline(client, request) {
  ...
  async postNotesPollsTranslate(client, request) {
    return NotesApi.postNotesPollsTranslate({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async getNotesReactions(client, request) {
  ...
  async postNotesShowPartialBulk(client, request) {
    return NotesApi.postNotesShowPartialBulk({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postNotesState(client, request) {
  ...
  async postNotesUpdate(client, request) {
    return NotesApi.postNotesUpdate({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postNotesUserListTimeline(client, request) {
...
export const Drive = {
  ...
  async postDriveFilesAttachedChatMessages(client, request) {
    return DriveApi.postDriveFilesAttachedChatMessages({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postDriveFilesAttachedNotes(client, request) {
  ...
  async postDriveFilesMoveBulk(client, request) {
    return DriveApi.postDriveFilesMoveBulk({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postDriveFilesShow(client, request) {
...
export const Users = {
  ...
  async postUsersTranslate(client, request) {
    return UsersApi.postUsersTranslate({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
};
...
export const Flash = {
  ...
  async postFlashGenToken(client, request) {
    return FlashApi.postFlashGenToken({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postFlashSearch(client, request) {
    return FlashApi.postFlashSearch({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
};
...
export const Groups = {
  async postUsersGroupsCreate(client, request) {
    return GroupsApi.postUsersGroupsCreate({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postUsersGroupsDelete(client, request) {
    return GroupsApi.postUsersGroupsDelete({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postUsersGroupsInvitationsAccept(client, request) {
    return GroupsApi.postUsersGroupsInvitationsAccept({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postUsersGroupsInvitationsReject(client, request) {
    return GroupsApi.postUsersGroupsInvitationsReject({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postUsersGroupsInvite(client, request) {
    return GroupsApi.postUsersGroupsInvite({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postUsersGroupsJoined(client) {
    return GroupsApi.postUsersGroupsJoined({
      fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postUsersGroupsLeave(client, request) {
    return GroupsApi.postUsersGroupsLeave({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postUsersGroupsOwned(client) {
    return GroupsApi.postUsersGroupsOwned({
      fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postUsersGroupsPull(client, request) {
    return GroupsApi.postUsersGroupsPull({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postUsersGroupsShow(client, request) {
    return GroupsApi.postUsersGroupsShow({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postUsersGroupsTransfer(client, request) {
    return GroupsApi.postUsersGroupsTransfer({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
  async postUsersGroupsUpdate(client, request) {
    return GroupsApi.postUsersGroupsUpdate({
      body: request, fetch: (url, method, body) => client._fetch(url, method, body)
    });
  },
};
