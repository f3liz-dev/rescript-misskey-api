...
import type {
  ...
  PostAdminAnnouncementsUpdateRequest,
  PostAdminAnnouncementsUpdateResponse,
  PostAdminAvatarDecorationsCopyRequest,
  PostAdminAvatarDecorationsCopyResponse,
  PostAdminAvatarDecorationsListRequest,
  PostAdminAvatarDecorationsListResponse,
  PostAdminAvatarDecorationsListRemoteRequest,
  PostAdminAvatarDecorationsListRemoteResponse,
  PostAdminDeleteAccountRequest,
  PostAdminDeleteAccountResponse,
  PostAdminDeleteAllFilesOfAuserRequest,
  PostAdminDeleteAllFilesOfAuserResponse,
  PostAdminDriveFilesRequest,
  PostAdminDriveFilesResponse,
  PostAdminDriveShowFileRequest,
  PostAdminDriveShowFileResponse,
  ...
  PostAdminEmojiListRemoteRequest,
  PostAdminEmojiListRemoteResponse,
  PostAdminEmojiStealRequest,
  PostAdminEmojiStealResponse,
  PostAdminEmojiUpdateRequest,
  PostAdminEmojiUpdateResponse,
  PostAdminInviteRevokeResponse,
  PostAdminQueueClearRequest,
  PostAdminQueueClearResponse,
  PostAdminQueueJobsRequest,
  PostAdminQueueJobsResponse,
  PostAdminQueuePromoteJobsRequest,
  PostAdminQueuePromoteJobsResponse,
  PostAdminQueueQueueStatsRequest,
  PostAdminQueueQueueStatsResponse,
  PostAdminQueueQueuesResponse,
  PostAdminQueueRemoveJobRequest,
  PostAdminQueueRemoveJobResponse,
  PostAdminQueueRetryJobRequest,
  PostAdminQueueRetryJobResponse,
  PostAdminQueueShowJobRequest,
  PostAdminQueueShowJobResponse,
  PostAdminQueueShowJobLogsRequest,
  PostAdminQueueShowJobLogsResponse,
  PostAdminResolveAbuseUserReportRequest,
  PostAdminResolveAbuseUserReportResponse,
  PostAdminRolesAssignRequest,
  PostAdminRolesAssignResponse,
...
import type {
  ...
  PostIsigninHistoryRequest,
  PostIsigninHistoryResponse,
  PostItruncateAccountRequest,
  PostItruncateAccountResponse,
  PostIupdateEmailRequest,
  PostIupdateEmailResponse,
  PostReversiGamesRequest,
  PostReversiGamesResponse,
...
import type {
  ...
  PostFederationFollowingRequest,
  PostFederationFollowingResponse,
  GetFederationRemoteSoftwareRequest,
  GetFederationRemoteSoftwareResponse,
  PostFederationRemoteSoftwareRequest,
  PostFederationRemoteSoftwareResponse,
  PostFederationShowInstanceRequest,
  PostFederationShowInstanceResponse,
  PostFederationUsersRequest,
  PostFederationUsersResponse,
...
import type {
  ...
  PostFlashMyLikesResponse,
  PostIResponse,
  PostIautoDeleteSettingsResponse,
  PostIfavoritesRequest,
  PostIfavoritesResponse,
  PostIfollowersServersResponse,
  PostIgalleryLikesRequest,
  PostIgalleryLikesResponse,
  PostIgalleryPostsRequest,
  PostIgalleryPostsResponse,
  ...
  PostIupdateRequest,
  PostIupdateResponse,
  PostIupdateAutoDeleteSettingsRequest,
  PostIupdateAutoDeleteSettingsResponse,
  PostIuserGroupInvitesRequest,
  PostIuserGroupInvitesResponse,
  PostMuteListRequest,
  PostMuteListResponse,
  PostRenoteMuteListRequest,
  PostRenoteMuteListResponse,
...
import type {
  ...
  PostNotesRequest,
  PostNotesResponse,
  PostNotesBubbleTimelineRequest,
  PostNotesBubbleTimelineResponse,
  PostNotesChildrenRequest,
  PostNotesChildrenResponse,
  PostNotesCreateRequest,
  PostNotesCreateResponse,
  PostNotesDraftsCountResponse,
  PostNotesDraftsCreateRequest,
  PostNotesDraftsCreateResponse,
  PostNotesDraftsDeleteRequest,
  PostNotesDraftsDeleteResponse,
  PostNotesDraftsListRequest,
  PostNotesDraftsListResponse,
  PostNotesDraftsUpdateRequest,
  PostNotesDraftsUpdateResponse,
  PostNotesEventsSearchRequest,
  PostNotesEventsSearchResponse,
  PostNotesGlobalTimelineRequest,
  PostNotesGlobalTimelineResponse,
  PostNotesHistoryRequest,
  PostNotesHistoryResponse,
  PostNotesHybridTimelineRequest,
  PostNotesHybridTimelineResponse,
  PostNotesLocalTimelineRequest,
  PostNotesLocalTimelineResponse,
  PostNotesMentionsRequest,
  PostNotesMentionsResponse,
  PostNotesPollsTranslateRequest,
  PostNotesPollsTranslateResponse,
  GetNotesReactionsRequest,
  GetNotesReactionsResponse,
  PostNotesReactionsRequest,
  PostNotesReactionsResponse,
  ...
  PostNotesShowRequest,
  PostNotesShowResponse,
  PostNotesShowPartialBulkRequest,
  PostNotesShowPartialBulkResponse,
  PostNotesStateRequest,
  PostNotesStateResponse,
  PostNotesTimelineRequest,
  PostNotesTimelineResponse,
  PostNotesUpdateRequest,
  PostNotesUpdateResponse,
  PostNotesUserListTimelineRequest,
  PostNotesUserListTimelineResponse,
...
import type {
  ...
  PostDriveFilesRequest,
  PostDriveFilesResponse,
  PostDriveFilesAttachedChatMessagesRequest,
  PostDriveFilesAttachedChatMessagesResponse,
  PostDriveFilesAttachedNotesRequest,
  PostDriveFilesAttachedNotesResponse,
  PostDriveFilesCreateRequest,
  PostDriveFilesCreateResponse,
  PostDriveFilesMoveBulkRequest,
  PostDriveFilesMoveBulkResponse,
  PostDriveFilesShowRequest,
  PostDriveFilesShowResponse,
  PostDriveFilesUpdateRequest,
  PostDriveFilesUpdateResponse,
...
import type {
  ...
  PostUsersShowRequest,
  PostUsersShowResponse,
  PostUsersTranslateRequest,
  PostUsersTranslateResponse,
...
import type {
  ...
  PostFlashCreateRequest,
  PostFlashCreateResponse,
  PostFlashGenTokenRequest,
  PostFlashGenTokenResponse,
  PostFlashSearchRequest,
  PostFlashSearchResponse,
...
import type {
  ...
  PostChatMessagesCreateToRoomRequest,
  PostChatMessagesCreateToRoomResponse,
  PostChatMessagesCreateToUserRequest,
  PostChatMessagesCreateToUserResponse,
  PostChatMessagesDeleteRequest,
  PostChatMessagesDeleteResponse,
  PostChatMessagesReactRequest,
  PostChatMessagesReactResponse,
  PostChatMessagesRoomTimelineRequest,
  PostChatMessagesRoomTimelineResponse,
  PostChatMessagesSearchRequest,
  PostChatMessagesSearchResponse,
  PostChatMessagesShowRequest,
  PostChatMessagesShowResponse,
  PostChatMessagesUnreactRequest,
  PostChatMessagesUnreactResponse,
  PostChatMessagesUserTimelineRequest,
  PostChatMessagesUserTimelineResponse,
  PostChatReadAllResponse,
  PostChatRoomsCreateRequest,
  PostChatRoomsCreateResponse,
  PostChatRoomsDeleteRequest,
  PostChatRoomsDeleteResponse,
  PostChatRoomsInvitationsCancelRequest,
  PostChatRoomsInvitationsCancelResponse,
  PostChatRoomsInvitationsCreateRequest,
  PostChatRoomsInvitationsCreateResponse,
  PostChatRoomsInvitationsIgnoreRequest,
  PostChatRoomsInvitationsIgnoreResponse,
  PostChatRoomsInvitationsInboxRequest,
  PostChatRoomsInvitationsInboxResponse,
  PostChatRoomsInvitationsOutboxRequest,
  PostChatRoomsInvitationsOutboxResponse,
  PostChatRoomsInvitationsRejectRequest,
  PostChatRoomsInvitationsRejectResponse,
  PostChatRoomsJoinRequest,
  PostChatRoomsJoinResponse,
  PostChatRoomsJoiningRequest,
  PostChatRoomsJoiningResponse,
  PostChatRoomsLeaveRequest,
  PostChatRoomsLeaveResponse,
  PostChatRoomsMembersRequest,
  PostChatRoomsMembersResponse,
  PostChatRoomsMuteRequest,
  PostChatRoomsMuteResponse,
  PostChatRoomsOwnedRequest,
  PostChatRoomsOwnedResponse,
  PostChatRoomsShowRequest,
  PostChatRoomsShowResponse,
  PostChatRoomsUpdateRequest,
  PostChatRoomsUpdateResponse,
} from '../types/Chat.d.ts';
import type {
  PostUsersGroupsCreateRequest,
  PostUsersGroupsCreateResponse,
  PostUsersGroupsDeleteRequest,
  PostUsersGroupsDeleteResponse,
  PostUsersGroupsInvitationsAcceptRequest,
  PostUsersGroupsInvitationsAcceptResponse,
  PostUsersGroupsInvitationsRejectRequest,
  PostUsersGroupsInvitationsRejectResponse,
  PostUsersGroupsInviteRequest,
  PostUsersGroupsInviteResponse,
  PostUsersGroupsJoinedResponse,
  PostUsersGroupsLeaveRequest,
  PostUsersGroupsLeaveResponse,
  PostUsersGroupsOwnedResponse,
  PostUsersGroupsPullRequest,
  PostUsersGroupsPullResponse,
  PostUsersGroupsShowRequest,
  PostUsersGroupsShowResponse,
  PostUsersGroupsTransferRequest,
  PostUsersGroupsTransferResponse,
  PostUsersGroupsUpdateRequest,
  PostUsersGroupsUpdateResponse,
} from '../types/Groups.d.ts';
...
**Credential required**: *Yes* / **Permission**: *write:admin:avatar-decorations* */
  export function postAdminAvatarDecorationsCopy(client: MisskeyClient, request: PostAdminAvatarDecorationsCopyRequest): Promise<PostAdminAvatarDecorationsCopyResponse>;
  /** admin/avatar-decorations/list - No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:admin:avatar-decorations* */
  export function postAdminAvatarDecorationsListRemote(client: MisskeyClient, request: PostAdminAvatarDecorationsListRemoteRequest): Promise<PostAdminAvatarDecorationsListRemoteResponse>;
  /** admin/delete-account - No description provided.

**Credential required**: *Yes* / **Permission**: *write:admin:delete-account* */
  export function postAdminDeleteAccount(client: MisskeyClient, request: PostAdminDeleteAccountRequest): Promise<PostAdminDeleteAccountResponse>;
...
**Credential required**: *Yes* / **Permission**: *write:admin:delete-all-files-of-a-user* */
  export function postAdminDeleteAllFilesOfAUser(client: MisskeyClient, request: PostAdminDeleteAllFilesOfAuserRequest): Promise<PostAdminDeleteAllFilesOfAuserResponse>;
  /** admin/drive/files - No description provided.
...
**Credential required**: *Yes* / **Permission**: *write:admin:emoji* */
  export function postAdminEmojiSteal(client: MisskeyClient, request: PostAdminEmojiStealRequest): Promise<PostAdminEmojiStealResponse>;
  /** admin/emoji/update - No description provided.
...
**Credential required**: *Yes* / **Permission**: *write:admin:invite-codes* */
  export function postAdminInviteRevoke(client: MisskeyClient): Promise<PostAdminInviteRevokeResponse>;
  /** admin/queue/clear - No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:admin:queue* */
  export function postAdminQueueJobs(client: MisskeyClient, request: PostAdminQueueJobsRequest): Promise<PostAdminQueueJobsResponse>;
  /** admin/queue/promote-jobs - No description provided.

**Credential required**: *Yes* / **Permission**: *write:admin:queue* */
  export function postAdminQueuePromoteJobs(client: MisskeyClient, request: PostAdminQueuePromoteJobsRequest): Promise<PostAdminQueuePromoteJobsResponse>;
  /** admin/queue/queue-stats - No description provided.

**Credential required**: *Yes* / **Permission**: *read:admin:queue* */
  export function postAdminQueueQueueStats(client: MisskeyClient, request: PostAdminQueueQueueStatsRequest): Promise<PostAdminQueueQueueStatsResponse>;
  /** admin/queue/queues - No description provided.

**Credential required**: *Yes* / **Permission**: *read:admin:queue* */
  export function postAdminQueueQueues(client: MisskeyClient): Promise<PostAdminQueueQueuesResponse>;
  /** admin/queue/remove-job - No description provided.

**Credential required**: *Yes* / **Permission**: *write:admin:queue* */
  export function postAdminQueueRemoveJob(client: MisskeyClient, request: PostAdminQueueRemoveJobRequest): Promise<PostAdminQueueRemoveJobResponse>;
  /** admin/queue/retry-job - No description provided.

**Credential required**: *Yes* / **Permission**: *write:admin:queue* */
  export function postAdminQueueRetryJob(client: MisskeyClient, request: PostAdminQueueRetryJobRequest): Promise<PostAdminQueueRetryJobResponse>;
  /** admin/queue/show-job - No description provided.

**Credential required**: *Yes* / **Permission**: *read:admin:queue* */
  export function postAdminQueueShowJob(client: MisskeyClient, request: PostAdminQueueShowJobRequest): Promise<PostAdminQueueShowJobResponse>;
  /** admin/queue/show-job-logs - No description provided.

**Credential required**: *Yes* / **Permission**: *read:admin:queue* */
  export function postAdminQueueShowJobLogs(client: MisskeyClient, request: PostAdminQueueShowJobLogsRequest): Promise<PostAdminQueueShowJobLogsResponse>;
  /** admin/resolve-abuse-user-report - No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:admin:server-info* */
  export function postAdminServerInfo(client: MisskeyClient): Promise<PostAdminServerInfoResponse>;
  /** admin/show-moderation-logs - No description provided.
...
**Internal Endpoint**: This endpoint is an API for the cherrypick mainframe and is not intended for use by third parties.
**Credential required**: *Yes* */
  export function postITruncateAccount(client: MisskeyClient, request: PostItruncateAccountRequest): Promise<PostItruncateAccountResponse>;
  /** i/update-email - No description provided.
...
**Credential required**: *No* */
  export function getServerInfo(client: MisskeyClient): Promise<GetServerInfoResponse>;
  /** server-info - No description provided.

**Credential required**: *No* */
  export function postServerInfo(client: MisskeyClient): Promise<PostServerInfoResponse>;
}
...
**Credential required**: *No* */
  export function getFederationRemoteSoftware(client: MisskeyClient, request: GetFederationRemoteSoftwareRequest): Promise<GetFederationRemoteSoftwareResponse>;
  /** federation/remote-software - No description provided.

**Credential required**: *No* */
  export function postFederationRemoteSoftware(client: MisskeyClient, request: PostFederationRemoteSoftwareRequest): Promise<PostFederationRemoteSoftwareResponse>;
  /** federation/show-instance - No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:account* */
  export function postIAutoDeleteSettings(client: MisskeyClient): Promise<PostIautoDeleteSettingsResponse>;
  /** i/favorites - No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:following* */
  export function postIFollowersServers(client: MisskeyClient): Promise<PostIfollowersServersResponse>;
  /** i/gallery/likes - No description provided.
...
**Credential required**: *Yes* / **Permission**: *write:account* */
  export function postIUpdateAutoDeleteSettings(client: MisskeyClient, request: PostIupdateAutoDeleteSettingsRequest): Promise<PostIupdateAutoDeleteSettingsResponse>;
  /** i/user-group-invites - No description provided.

**Credential required**: *Yes* / **Permission**: *read:user-groups* */
  export function postIUserGroupInvites(client: MisskeyClient, request: PostIuserGroupInvitesRequest): Promise<PostIuserGroupInvitesResponse>;
  /** mute/list - No description provided.
...
**Credential required**: *No* */
  export function postVerifyEmail(client: MisskeyClient, request: PostVerifyEmailRequest): Promise<PostVerifyEmailResponse>;
}
...
**Credential required**: *No* */
  export function postNotesBubbleTimeline(client: MisskeyClient, request: PostNotesBubbleTimelineRequest): Promise<PostNotesBubbleTimelineResponse>;
  /** notes/children - No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:account* */
  export function postNotesDraftsCount(client: MisskeyClient): Promise<PostNotesDraftsCountResponse>;
  /** notes/drafts/create - No description provided.

**Credential required**: *Yes* / **Permission**: *write:account* */
  export function postNotesDraftsCreate(client: MisskeyClient, request: PostNotesDraftsCreateRequest): Promise<PostNotesDraftsCreateResponse>;
  /** notes/drafts/delete - No description provided.

**Credential required**: *Yes* / **Permission**: *write:account* */
  export function postNotesDraftsDelete(client: MisskeyClient, request: PostNotesDraftsDeleteRequest): Promise<PostNotesDraftsDeleteResponse>;
  /** notes/drafts/list - No description provided.

**Credential required**: *Yes* / **Permission**: *read:account* */
  export function postNotesDraftsList(client: MisskeyClient, request: PostNotesDraftsListRequest): Promise<PostNotesDraftsListResponse>;
  /** notes/drafts/update - No description provided.

**Credential required**: *Yes* / **Permission**: *write:account* */
  export function postNotesDraftsUpdate(client: MisskeyClient, request: PostNotesDraftsUpdateRequest): Promise<PostNotesDraftsUpdateResponse>;
  /** notes/events/search - No description provided.

**Credential required**: *No* */
  export function postNotesEventsSearch(client: MisskeyClient, request: PostNotesEventsSearchRequest): Promise<PostNotesEventsSearchResponse>;
  /** notes/global-timeline - No description provided.
...
**Credential required**: *No* */
  export function postNotesHistory(client: MisskeyClient, request: PostNotesHistoryRequest): Promise<PostNotesHistoryResponse>;
  /** notes/hybrid-timeline - No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:account* */
  export function postNotesPollsTranslate(client: MisskeyClient, request: PostNotesPollsTranslateRequest): Promise<PostNotesPollsTranslateResponse>;
  /** notes/reactions - No description provided.
...
**Credential required**: *No* */
  export function postNotesShowPartialBulk(client: MisskeyClient, request: PostNotesShowPartialBulkRequest): Promise<PostNotesShowPartialBulkResponse>;
  /** notes/state - No description provided.
...
**Credential required**: *Yes* / **Permission**: *write:notes* */
  export function postNotesUpdate(client: MisskeyClient, request: PostNotesUpdateRequest): Promise<PostNotesUpdateResponse>;
  /** notes/user-list-timeline - No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:account* */
  export function postClipsList(client: MisskeyClient, request: PostClipsListRequest): Promise<PostClipsListResponse>;
  /** clips/show - No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:drive* */
  export function postDriveFilesAttachedChatMessages(client: MisskeyClient, request: PostDriveFilesAttachedChatMessagesRequest): Promise<PostDriveFilesAttachedChatMessagesResponse>;
  /** drive/files/attached-notes - Find the notes to which the given file is attached.
...
**Credential required**: *Yes* / **Permission**: *write:drive* */
  export function postDriveFilesMoveBulk(client: MisskeyClient, request: PostDriveFilesMoveBulkRequest): Promise<PostDriveFilesMoveBulkResponse>;
  /** drive/files/show - Show the properties of a drive file.
...
**Credential required**: *Yes* / **Permission**: *read:account* */
  export function postUsersTranslate(client: MisskeyClient, request: PostUsersTranslateRequest): Promise<PostUsersTranslateResponse>;
}
...
**Internal Endpoint**: This endpoint is an API for the cherrypick mainframe and is not intended for use by third parties.
**Credential required**: *Yes* */
  export function postFlashGenToken(client: MisskeyClient, request: PostFlashGenTokenRequest): Promise<PostFlashGenTokenResponse>;
  /** flash/search - No description provided.

**Credential required**: *No* */
  export function postFlashSearch(client: MisskeyClient, request: PostFlashSearchRequest): Promise<PostFlashSearchResponse>;
}
...
**Credential required**: *Yes* / **Permission**: *read:chat* */
  export function postChatHistory(client: MisskeyClient, request: PostChatHistoryRequest): Promise<PostChatHistoryResponse>;
  /** chat/messages/create-to-room - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatMessagesCreateToRoom(client: MisskeyClient, request: PostChatMessagesCreateToRoomRequest): Promise<PostChatMessagesCreateToRoomResponse>;
  /** chat/messages/create-to-user - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatMessagesCreateToUser(client: MisskeyClient, request: PostChatMessagesCreateToUserRequest): Promise<PostChatMessagesCreateToUserResponse>;
  /** chat/messages/delete - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatMessagesDelete(client: MisskeyClient, request: PostChatMessagesDeleteRequest): Promise<PostChatMessagesDeleteResponse>;
  /** chat/messages/react - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatMessagesReact(client: MisskeyClient, request: PostChatMessagesReactRequest): Promise<PostChatMessagesReactResponse>;
  /** chat/messages/room-timeline - No description provided.

**Credential required**: *Yes* / **Permission**: *read:chat* */
  export function postChatMessagesRoomTimeline(client: MisskeyClient, request: PostChatMessagesRoomTimelineRequest): Promise<PostChatMessagesRoomTimelineResponse>;
  /** chat/messages/search - No description provided.

**Credential required**: *Yes* / **Permission**: *read:chat* */
  export function postChatMessagesSearch(client: MisskeyClient, request: PostChatMessagesSearchRequest): Promise<PostChatMessagesSearchResponse>;
  /** chat/messages/show - No description provided.

**Credential required**: *Yes* / **Permission**: *read:chat* */
  export function postChatMessagesShow(client: MisskeyClient, request: PostChatMessagesShowRequest): Promise<PostChatMessagesShowResponse>;
  /** chat/messages/unreact - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatMessagesUnreact(client: MisskeyClient, request: PostChatMessagesUnreactRequest): Promise<PostChatMessagesUnreactResponse>;
  /** chat/messages/user-timeline - No description provided.

**Credential required**: *Yes* / **Permission**: *read:chat* */
  export function postChatMessagesUserTimeline(client: MisskeyClient, request: PostChatMessagesUserTimelineRequest): Promise<PostChatMessagesUserTimelineResponse>;
  /** chat/read-all - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatReadAll(client: MisskeyClient): Promise<PostChatReadAllResponse>;
  /** chat/rooms/create - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatRoomsCreate(client: MisskeyClient, request: PostChatRoomsCreateRequest): Promise<PostChatRoomsCreateResponse>;
  /** chat/rooms/delete - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatRoomsDelete(client: MisskeyClient, request: PostChatRoomsDeleteRequest): Promise<PostChatRoomsDeleteResponse>;
  /** chat/rooms/invitations/cancel - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatRoomsInvitationsCancel(client: MisskeyClient, request: PostChatRoomsInvitationsCancelRequest): Promise<PostChatRoomsInvitationsCancelResponse>;
  /** chat/rooms/invitations/create - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatRoomsInvitationsCreate(client: MisskeyClient, request: PostChatRoomsInvitationsCreateRequest): Promise<PostChatRoomsInvitationsCreateResponse>;
  /** chat/rooms/invitations/ignore - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatRoomsInvitationsIgnore(client: MisskeyClient, request: PostChatRoomsInvitationsIgnoreRequest): Promise<PostChatRoomsInvitationsIgnoreResponse>;
  /** chat/rooms/invitations/inbox - No description provided.

**Credential required**: *Yes* / **Permission**: *read:chat* */
  export function postChatRoomsInvitationsInbox(client: MisskeyClient, request: PostChatRoomsInvitationsInboxRequest): Promise<PostChatRoomsInvitationsInboxResponse>;
  /** chat/rooms/invitations/outbox - No description provided.

**Credential required**: *Yes* / **Permission**: *read:chat* */
  export function postChatRoomsInvitationsOutbox(client: MisskeyClient, request: PostChatRoomsInvitationsOutboxRequest): Promise<PostChatRoomsInvitationsOutboxResponse>;
  /** chat/rooms/invitations/reject - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatRoomsInvitationsReject(client: MisskeyClient, request: PostChatRoomsInvitationsRejectRequest): Promise<PostChatRoomsInvitationsRejectResponse>;
  /** chat/rooms/join - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatRoomsJoin(client: MisskeyClient, request: PostChatRoomsJoinRequest): Promise<PostChatRoomsJoinResponse>;
  /** chat/rooms/joining - No description provided.

**Credential required**: *Yes* / **Permission**: *read:chat* */
  export function postChatRoomsJoining(client: MisskeyClient, request: PostChatRoomsJoiningRequest): Promise<PostChatRoomsJoiningResponse>;
  /** chat/rooms/leave - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatRoomsLeave(client: MisskeyClient, request: PostChatRoomsLeaveRequest): Promise<PostChatRoomsLeaveResponse>;
  /** chat/rooms/members - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatRoomsMembers(client: MisskeyClient, request: PostChatRoomsMembersRequest): Promise<PostChatRoomsMembersResponse>;
  /** chat/rooms/mute - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatRoomsMute(client: MisskeyClient, request: PostChatRoomsMuteRequest): Promise<PostChatRoomsMuteResponse>;
  /** chat/rooms/owned - No description provided.

**Credential required**: *Yes* / **Permission**: *read:chat* */
  export function postChatRoomsOwned(client: MisskeyClient, request: PostChatRoomsOwnedRequest): Promise<PostChatRoomsOwnedResponse>;
  /** chat/rooms/show - No description provided.

**Credential required**: *Yes* / **Permission**: *read:chat* */
  export function postChatRoomsShow(client: MisskeyClient, request: PostChatRoomsShowRequest): Promise<PostChatRoomsShowResponse>;
  /** chat/rooms/update - No description provided.

**Credential required**: *Yes* / **Permission**: *write:chat* */
  export function postChatRoomsUpdate(client: MisskeyClient, request: PostChatRoomsUpdateRequest): Promise<PostChatRoomsUpdateResponse>;
}
...
**Credential required**: *Yes* / **Permission**: *write:user-groups* */
  export function postUsersGroupsCreate(client: MisskeyClient, request: PostUsersGroupsCreateRequest): Promise<PostUsersGroupsCreateResponse>;
  /** users/groups/delete - Delete an existing group.

**Credential required**: *Yes* / **Permission**: *write:user-groups* */
  export function postUsersGroupsDelete(client: MisskeyClient, request: PostUsersGroupsDeleteRequest): Promise<PostUsersGroupsDeleteResponse>;
  /** users/groups/invitations/accept - No description provided.

**Credential required**: *Yes* / **Permission**: *write:user-groups* */
  export function postUsersGroupsInvitationsAccept(client: MisskeyClient, request: PostUsersGroupsInvitationsAcceptRequest): Promise<PostUsersGroupsInvitationsAcceptResponse>;
  /** users/groups/invitations/reject - No description provided.

**Credential required**: *Yes* / **Permission**: *write:user-groups* */
  export function postUsersGroupsInvitationsReject(client: MisskeyClient, request: PostUsersGroupsInvitationsRejectRequest): Promise<PostUsersGroupsInvitationsRejectResponse>;
  /** users/groups/invite - Invite a user to an existing group.

**Credential required**: *Yes* / **Permission**: *write:user-groups* */
  export function postUsersGroupsInvite(client: MisskeyClient, request: PostUsersGroupsInviteRequest): Promise<PostUsersGroupsInviteResponse>;
  /** users/groups/joined - List the groups that the authenticated user is a member of.

**Credential required**: *Yes* / **Permission**: *read:user-groups* */
  export function postUsersGroupsJoined(client: MisskeyClient): Promise<PostUsersGroupsJoinedResponse>;
...
**Credential required**: *Yes* / **Permission**: *write:user-groups* */
  export function postUsersGroupsLeave(client: MisskeyClient, request: PostUsersGroupsLeaveRequest): Promise<PostUsersGroupsLeaveResponse>;
  /** users/groups/owned - List the groups that the authenticated user is the owner of.

**Credential required**: *Yes* / **Permission**: *read:user-groups* */
  export function postUsersGroupsOwned(client: MisskeyClient): Promise<PostUsersGroupsOwnedResponse>;
  /** users/groups/pull - Removes a specified user from a group. The owner can not be removed.

**Credential required**: *Yes* / **Permission**: *write:user-groups* */
  export function postUsersGroupsPull(client: MisskeyClient, request: PostUsersGroupsPullRequest): Promise<PostUsersGroupsPullResponse>;
  /** users/groups/show - Show the properties of a group.

**Credential required**: *Yes* / **Permission**: *read:user-groups* */
  export function postUsersGroupsShow(client: MisskeyClient, request: PostUsersGroupsShowRequest): Promise<PostUsersGroupsShowResponse>;
  /** users/groups/transfer - Transfer ownership of a group from the authenticated user to another user.

**Credential required**: *Yes* / **Permission**: *write:user-groups* */
  export function postUsersGroupsTransfer(client: MisskeyClient, request: PostUsersGroupsTransferRequest): Promise<PostUsersGroupsTransferResponse>;
  /** users/groups/update - Update the properties of a group.

**Credential required**: *Yes* / **Permission**: *write:user-groups* */
  export function postUsersGroupsUpdate(client: MisskeyClient, request: PostUsersGroupsUpdateRequest): Promise<PostUsersGroupsUpdateResponse>;
}