...
/** OK (with results) */
export type PostAdminAccountsFindByEmailResponse = ComponentSchemas.UserDetailedNotMe;
...
export interface PostAdminAvatarDecorationsCopyRequest {
  decorationId: string;
}
/** OK (with results) */
export interface PostAdminAvatarDecorationsCopyResponse {
  id: string;
}
...
export interface PostAdminAvatarDecorationsListRemoteRequest {
  limit?: number;
  sinceId?: string;
  untilId?: string;
  userId?: unknown;
...
export interface PostAdminDeleteAccountRequest {
  userId: string;
}
export type PostAdminDeleteAccountResponse = void;

export interface PostAdminDeleteAllFilesOfAuserRequest {
  userId: string;
}
export type PostAdminDeleteAllFilesOfAuserResponse = void;
...
export type PostAdminDriveShowFileRequest = {
  fileId: string;
} | {
  url: string;
};
...
export interface PostAdminEmojiStealRequest {
  name: string;
  host: string;
}
/** OK (with results) */
export interface PostAdminEmojiStealResponse {
  id: string;
}

export type PostAdminEmojiUpdateRequest = {
  id: string;
} | {
  name: string;
} & {
...
export type PostAdminInviteRevokeResponse = void;
...
export interface PostAdminQueueJobsRequest {
  queue: string;
  state: string[];
  search?: string;
}
/** OK (with results) */
export type PostAdminQueueJobsResponse = ComponentSchemas.QueueJob[];

export interface PostAdminQueuePromoteJobsRequest {
  queue: string;
}
export type PostAdminQueuePromoteJobsResponse = void;

export interface PostAdminQueueQueueStatsRequest {
  queue: string;
}
/** OK (with results) */
export interface PostAdminQueueQueueStatsResponse {
  name: string;
  qualifiedName: string;
  counts: Record<string, never>;
  isPaused: boolean;
  metrics: {
  completed: ComponentSchemas.QueueMetrics;
  failed: ComponentSchemas.QueueMetrics;
};
  db: {
  version: string;
  mode: string;
...
/** OK (with results) */
export type PostAdminQueueQueuesResponse = {
  name: string;
  counts: Record<string, never>;
  isPaused: boolean;
  metrics: {
...
export interface PostAdminQueueRemoveJobRequest {
  queue: string;
  jobId: string;
}
export type PostAdminQueueRemoveJobResponse = void;

export interface PostAdminQueueRetryJobRequest {
  queue: string;
  jobId: string;
}
export type PostAdminQueueRetryJobResponse = void;

export interface PostAdminQueueShowJobRequest {
  queue: string;
  jobId: string;
}
/** OK (with results) */
export type PostAdminQueueShowJobResponse = ComponentSchemas.QueueJob;

export interface PostAdminQueueShowJobLogsRequest {
  queue: string;
  jobId: string;
}
/** OK (with results) */
export type PostAdminQueueShowJobLogsResponse = string[];
...
/** OK (with results) */
export interface PostAdminServerInfoResponse {
  machine: string;
  os: string;
  node: string;
  psql: string;
...
**Credential required**: *Yes* / **Permission**: *write:admin:avatar-decorations*
   */
  postAdminAvatarDecorationsCopy(client: MisskeyClient, request: PostAdminAvatarDecorationsCopyRequest): Promise<PostAdminAvatarDecorationsCopyResponse>;
/**
   * admin/avatar-decorations/list
   * No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:admin:avatar-decorations*
   */
  postAdminAvatarDecorationsListRemote(client: MisskeyClient, request: PostAdminAvatarDecorationsListRemoteRequest): Promise<PostAdminAvatarDecorationsListRemoteResponse>;
/**
...
**Credential required**: *Yes* / **Permission**: *write:admin:delete-account*
   */
  postAdminDeleteAccount(client: MisskeyClient, request: PostAdminDeleteAccountRequest): Promise<PostAdminDeleteAccountResponse>;
/**
...
**Credential required**: *Yes* / **Permission**: *write:admin:delete-all-files-of-a-user*
   */
  postAdminDeleteAllFilesOfAUser(client: MisskeyClient, request: PostAdminDeleteAllFilesOfAuserRequest): Promise<PostAdminDeleteAllFilesOfAuserResponse>;
/**
   * admin/drive/files
   * No description provided.
...
**Credential required**: *Yes* / **Permission**: *write:admin:emoji*
   */
  postAdminEmojiSteal(client: MisskeyClient, request: PostAdminEmojiStealRequest): Promise<PostAdminEmojiStealResponse>;
/**
   * admin/emoji/update
   * No description provided.
...
**Credential required**: *Yes* / **Permission**: *write:admin:invite-codes*
   */
  postAdminInviteRevoke(client: MisskeyClient): Promise<PostAdminInviteRevokeResponse>;
/**
   * admin/queue/clear
   * No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:admin:queue*
   */
  postAdminQueueJobs(client: MisskeyClient, request: PostAdminQueueJobsRequest): Promise<PostAdminQueueJobsResponse>;
/**
...
**Credential required**: *Yes* / **Permission**: *write:admin:queue*
   */
  postAdminQueuePromoteJobs(client: MisskeyClient, request: PostAdminQueuePromoteJobsRequest): Promise<PostAdminQueuePromoteJobsResponse>;
/**
...
**Credential required**: *Yes* / **Permission**: *read:admin:queue*
   */
  postAdminQueueQueueStats(client: MisskeyClient, request: PostAdminQueueQueueStatsRequest): Promise<PostAdminQueueQueueStatsResponse>;
/**
   * admin/queue/queues
   * No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:admin:queue*
   */
  postAdminQueueQueues(client: MisskeyClient): Promise<PostAdminQueueQueuesResponse>;
/**
...
**Credential required**: *Yes* / **Permission**: *write:admin:queue*
   */
  postAdminQueueRemoveJob(client: MisskeyClient, request: PostAdminQueueRemoveJobRequest): Promise<PostAdminQueueRemoveJobResponse>;
/**
...
**Credential required**: *Yes* / **Permission**: *write:admin:queue*
   */
  postAdminQueueRetryJob(client: MisskeyClient, request: PostAdminQueueRetryJobRequest): Promise<PostAdminQueueRetryJobResponse>;
/**
...
**Credential required**: *Yes* / **Permission**: *read:admin:queue*
   */
  postAdminQueueShowJob(client: MisskeyClient, request: PostAdminQueueShowJobRequest): Promise<PostAdminQueueShowJobResponse>;
/**
...
**Credential required**: *Yes* / **Permission**: *read:admin:queue*
   */
  postAdminQueueShowJobLogs(client: MisskeyClient, request: PostAdminQueueShowJobLogsRequest): Promise<PostAdminQueueShowJobLogsResponse>;
/**
   * admin/resolve-abuse-user-report
   * No description provided.
...
**Credential required**: *Yes* / **Permission**: *read:admin:server-info*
   */
  postAdminServerInfo(client: MisskeyClient): Promise<PostAdminServerInfoResponse>;
/**
   * admin/show-moderation-logs
   * No description provided.
